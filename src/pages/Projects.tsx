...
function Projects() {
  ...
  return (
    <div className="w-full min-h-[100vh] bg-black text-white text-center flex flex-col justify-center items-center" id="projects">
      <h1 className="text-center font-bold text-2xl sm:text-3xl md:text-4xl lg:text-7xl py-7 mb-4">Projects</h1>
      <div className='flex justify-center items-center w-full'>
        <button onClick={() => handleScroll('left')} className='md:bg-purple-600 rounded-full md:p-4 flex p-1'>
          <ChevronLeftIcon fontSize='large'/>
        </button>
        <div ref={scrollContainerRef} className="overflow-hidden whitespace-nowrap flex w-full lg:w-[70%]">
        ...
        <button onClick={() => handleScroll('right')} className='md:bg-purple-600 rounded-full md:p-4 flex p-1'>
