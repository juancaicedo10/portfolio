...
function ProjectCard({ title, description, image }: ProjectCardProps) {
  return (
    <div className="w-[450px] m-5 rounded-lg shadow-lg border-2 border-gray bg-black flex flex-col justify-center items-center text-white transition-all duration-200 transform hover:scale-105 z-10">
