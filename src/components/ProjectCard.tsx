...
type ProjectCardProps = {
  ...
  image: string;
    ...
    function ProjectCard({ title, description, image }: ProjectCardProps) {
      return (
        <div className="min-w-full md:min-w-[45%] lg:min-w-[350px] xl:min-w-[400px] md:m-[16px] rounded-lg shadow-lg border-2 border-gray bg-black flex flex-col justify-center items-center text-white transition-all duration-200 transform md:hover:scale-105 z-10 whitespace-normal">
